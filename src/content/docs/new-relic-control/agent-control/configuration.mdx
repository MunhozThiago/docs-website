...
Agent Control provides a seamless approach for configuration independently of the environment where it is deployed. Two methods for managing agent configurations are available:
