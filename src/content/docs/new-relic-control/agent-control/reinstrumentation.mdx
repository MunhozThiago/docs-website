...
metaDescription: "How to migrate existing New Relic agents to be managed by Agent Control on Kubernetes, Linux, and Windows"
...
<Callout variant="caution" title="Is this the right page?">
  This page is for environments where New Relic agents are **already running** and you want to bring them under Agent Control management. If you are setting up Agent Control for the first time on a clean environment, go to [Install Agent Control](/docs/new-relic-control/agent-control/setup/) instead.
</Callout>
...
<DocTiles>
  ...
  >
    Configure agents locally or through Fleet Control remote configuration.
  </DocTile>
